  ...
  return (
    ...
    >
      <style>{`
        ...
        .input-field:focus { border-color: #6366f1 !important; box-shadow: 0 0 0 3px rgba(99,102,241,0.12) !important; background: #fff !important; }
        .tab-btn { transition: all 0.2s; }
        .tab-btn:hover { background: rgba(99,102,241,0.07) !important; }
        .save-btn { transition: all 0.2s; }
        .save-btn:hover { transform: translateY(-1px); box-shadow: 0 6px 20px rgba(99,102,241,0.35) !important; }
        .save-btn:active { transform: translateY(0); }
        .upload-btn:hover { background: #4338ca !important; }
          ...
          {tabs.map((tab) => (
            <button
              ...
              style={{
                ...
                color:
                  activeTab === tab.id ? "#4f46e5" : "rgba(255,255,255,0.85)",
                boxShadow:
