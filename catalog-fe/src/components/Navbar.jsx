    ...
    <>
      <nav className="flex items-center justify-between px-6 md:px-10 py-3.5 border-b border-gray-200 bg-white sticky top-0 z-[100]">
        ...
        >
          ...
          {/* Dropdown */}
          {user && showDropdown && (
            <div className="absolute top-[110%] right-0 bg-white rounded-xl shadow-[0_8px_24px_rgba(0,0,0,0.10)] min-w-[170px] overflow-hidden z-[110] border border-gray-100">
              <div
                onClick={() => navigate("/profile")}
                className="flex items-center gap-2 px-4 py-3 text-sm text-gray-800 cursor-pointer hover:bg-gray-50 transition-colors"
              >
              ...
              <div
                ...
                className="flex items-center gap-2 px-4 py-3 text-sm font-semibold text-red-600 cursor-pointer hover:bg-red-50 transition-colors"
              >
                <FiLogOut size={14} />
                Logout
              </div>
      ...
      {/* ── MOBILE DRAWER ── */}
      <div
        className={`fixed top-0 right-0 h-full w-[280px] bg-white z-[200] flex flex-col shadow-2xl md:hidden transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
          ...
          <button
            onClick={closeMobile}
            className="w-9 h-9 flex items-center justify-center rounded-xl hover:bg-gray-100 text-gray-500 border-0 bg-transparent cursor-pointer transition-colors"
          >
            <FiX size={20} />
          </button>
        </div>
        ...
        {user && (
          ...
          >
            <div className="w-10 h-10 rounded-full bg-[#072B50] flex items-center justify-center flex-shrink-0">
